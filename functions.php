...
function tc_ga_script() {
  $script = "";
  $ga_id = get_option('wp_nn_theme_ga_id');
  if ($ga_id){
    $script .= "<script>
...
function is_inquiryset_resource($resource_title, $return_details = false){
    global $wpdb;
...
function tc_compareType($array1, $array2) {
