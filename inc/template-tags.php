...
if ( ! function_exists( 'wp_nn_theme_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function wp_nn_theme_posted_on() {
		...
		$posted_on = sprintf(
			...
			esc_html_x( 'Posted on %s', 'post date', 'wp_nn_theme' ),
...
if ( ! function_exists( 'wp_nn_theme_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function wp_nn_theme_posted_by() {
		$byline = sprintf(
			/* translators: %s: post author. */
			esc_html_x( 'by %s', 'post author', 'wp_nn_theme' ),
...
if ( ! function_exists( 'wp_nn_theme_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function wp_nn_theme_entry_footer() {
		// Hide category and tag text for pages.
		if ( 'post' === get_post_type() ) {
			/* translators: used between list items, there is a space after the comma */
			$categories_list = get_the_category_list( esc_html__( ', ', 'wp_nn_theme' ) );
			if ( $categories_list ) {
			...
			/* translators: used between list items, there is a space after the comma */
			$tags_list = get_the_tag_list( '', esc_html_x( ', ', 'list item separator', 'wp_nn_theme' ) );
			if ( $tags_list ) {
...
if ( ! function_exists( 'wp_nn_theme_post_thumbnail' ) ) :
	 ...
	 */
	function wp_nn_theme_post_thumbnail() {
