...
<figure class="wp-block-image size-full is-resized"><a href="/" rel="home"><img src="http://codex.local/wp-content/uploads/2025/01/Logo-Horizontal.svg" alt="Navigate to Navigation North Home Page" class="wp-image-480" style="width:232px;height:auto"/></a></figure>
<!-- /wp:image -->
...
<!-- wp:image {"id":484,"linkDestination":"custom","className":"wp-block-image size-full is-resized footer-muse-logo"} -->
<figure class="wp-block-image size-full is-resized footer-muse-logo"><a href="https://museable.com/" target="_blank" rel=" noreferrer noopener"><img src="http://codex.local/wp-content/uploads/2025/01/Museable-Logo.svg" alt="Navigate to Museable Official Site" class="wp-image-484"/></a></figure>
<!-- /wp:image --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
